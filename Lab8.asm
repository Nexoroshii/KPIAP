...
install_int1Ch_handler PROC
    ...
    mov ax,251Ch                 ;ustanovit adres obrabotchika preryv
    cli                          ;AL - nomer preryvanija (?????? ?? ???????)
    int 21h
    sti
...
check_int60h_handler PROC
    ...
    mov ax,3560h                 ;get adress obrabotchika preryv
    int 21h
...
install:
    ...
    mov ax,3100h                              ;ostavit' programmu rezidentnoj
